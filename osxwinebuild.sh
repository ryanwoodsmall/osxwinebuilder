...
#   devel
WINEDEVELVERSION="1.5.13"
WINEDEVELSHA1SUM="aee941aacbc748fc93fd0a49b76520586cdc304d"
#   CrossOver Wine
...
# gecko
#
GECKOVERSIONS="1.0.0-x86.cab 1.1.0-x86.cab 1.2.0-x86.msi 1.3-x86.msi 1.4-x86.msi 1.5-x86.msi 1.6-x86.msi 1.7-x86.msi"
